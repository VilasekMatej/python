...
"""Tata funkce zjistí jestli je cislo v listu"""
def cislo():
    ...
    """
    list = [1, 3, 4, 7, 9]
    # Procházení čísel od 1 do 10
    for i in range(1, 11):
        #kontrola a výpis zda je číslo obsaženo v listu nebo ne
        if i in list:
            print("cislo " + str(i) + " je v listu")
        elif i != list:
            print("cislo " + str(i) + " není v listu")
