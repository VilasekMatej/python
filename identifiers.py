...
PI = 3.14
city = "Opava"
hildasspuopavacz = 'Hilda Dokonalá'
password2 = 'TajneHeslo'
agent007 = 'James Bond'

"""do globalu jsem přidal 1 protože to je globální proměnná takže jí nemůžu změnit
v hilděsspu jsem odebral speciální znaky, protože tam nemůžou být
a u agenta nesmí být čísla na začátku proměnné"""
